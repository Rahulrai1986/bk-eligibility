...
WebUI.setText(findTestObject('login/inout_kycnumber2'), '12345')

WebUI.click(findTestObject('login/error_aadhar_final1'))

WebUI.verifyTextPresent('Please enter valid aadhaar', false)

WebUI.verifyElementNotClickable(findTestObject('login/Submit_button'))
