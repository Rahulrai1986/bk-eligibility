...
WebUI.setText(findTestObject('login/Input_KYC number'), 'MP13N20120124300')

WebUI.delay(2)

WebUI.click(findTestObject('login/DOB'))
...
test1 = WebUI.getText(findTestObject('login/ERROR_messagedl1'))
