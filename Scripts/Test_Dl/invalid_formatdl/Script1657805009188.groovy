...
WebUI.setText(findTestObject('login/Input_KYC number'), 'MP15N009988G')
...
WebUI.click(findTestObject('login/click_year'))

WebUI.click(findTestObject('login/select_year'))

WebUI.click(findTestObject('login/select_month'))

WebUI.click(findTestObject('login/date'))

WebUI.click(findTestObject('login/submit_btn2'))

test1 = WebUI.getText(findTestObject('login/error_messagedl'))
