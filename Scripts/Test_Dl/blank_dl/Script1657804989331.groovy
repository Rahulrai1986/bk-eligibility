...
WebUI.click(findTestObject('login/span_dlnumber'))

WebUI.setText(findTestObject('login/Input_KYC number'), '')

WebUI.click(findTestObject('login/Input_KYC number'))

WebUI.click(findTestObject('login/blank_dlerrormessage'))

WebUI.delay(4)

message1 = WebUI.getText(findTestObject('login/error_messagedl'))

System.println(message1)

WebUI.verifyElementNotClickable(findTestObject('login/submit_btn2'))
