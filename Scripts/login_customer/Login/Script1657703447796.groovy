...
WebUI.setText(findTestObject('login/Input_KYC number'), '811724786992')

WebUI.click(findTestObject('Object Repository/validaadhar/Page_Check Eligibility  Sign up/button_Submit'))

WebUI.setText(findTestObject('Object Repository/validaadhar/Page_Check Eligibility  KYC/input_First name_mat-input-2'), 
    'RAHUL')

WebUI.setText(findTestObject('Object Repository/validaadhar/Page_Check Eligibility  KYC/input_Last name_mat-input-3'), 'RAI')

WebUI.setText(findTestObject('Object Repository/validaadhar/Page_Check Eligibility  KYC/input_Enter Pin Code_mat-input-4'), 
    '470002')

WebUI.click(findTestObject('Object Repository/validaadhar/Page_Check Eligibility  KYC/span_Submit'))
